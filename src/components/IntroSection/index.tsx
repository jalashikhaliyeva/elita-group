        ...
        {introData.map((item, idx) => {
          ...
          return (
            <div
              key={idx}
              className={`
                group relative cursor-pointer px-6 md:px-10 overflow-hidden transition-all duration-700 ease-in-out
                ${
                  isMobile
              ...
              <div className="relative z-10 flex flex-col justify-between h-full w-full">
                ...
                <div className="flex flex-col mt-auto">
                  ...
                  >
                    ...
                    <div className="text-white leading-4 font-normal text-sm md:text-base flex flex-row items-center gap-2">
                      Ətraflı
                      <svg
                        width="16"
                        height="16"
